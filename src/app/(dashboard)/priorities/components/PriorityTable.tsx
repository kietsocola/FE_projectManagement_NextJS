                    ...
                    {showSkeleton ? (
                        Array.from({ length: 5 }).map((_, idx) => (
                            <tr key={idx} className="animate-pulse">
                                ...
                                <td className="px-3 py-2"><div className="h-4 w-12 bg-gray-100 rounded" /></td>
                        ...
                        priorities.map(priority => (
                            ...
                            >
                                <td className="px-3 py-2">{priority.name}</td>
                                ...
                                <td className="px-3 py-2">{priority.description}</td>
                                {/* <td className="px-3 py-2">{priority.sortOrder ?? ''}</td> */}
                                <td className="px-3 py-2">{priority.createdAt ? new Date(priority.createdAt).toLocaleString() : ''}</td>
                                <td className="px-3 py-2">
